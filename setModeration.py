...
banned_keyword_list = ['clip', 'create', 'remove', 'delete', 'mod', 'moderator', 'moderators', 'channel', 'show', 'me', 'the','admin', 'watch', 'want', 'start', 'set', 'add', 'to', 'put', 'please', 'online', 'know', 'stream', 'stop','show', 'from', 'by', 'where', 'when', 'because', 'while', 'what', 'make', 'would', 'will', 'might', 'may', 'can', 'could', 'shall', 'should', 'must', 'like', 'have', 'had', 'does', 'tell']
#2. Add moderator
