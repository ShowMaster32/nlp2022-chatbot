...
banned_keyword_list = ['clip', 'create', 'generate', 'produce', 'the', 'please', 'make', 'want', 'show', 'online', 'from', 'know', 'by', 'where', 'when', 'because', 'while', 'what', 'make', 'would', 'will', 'might', 'may', 'can', 'could', 'shall', 'should', 'must', 'like', 'have', 'had', 'does']
#
